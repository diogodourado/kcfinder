<?php
/** Brazilian Portuguese localization file for KCFinder
  * author: Alexandre Benegas Ferreira <alexbenegas@hotmail.com>
  * update: Diogo Dourado <diogo@dourado.net>
  */

$lang = array(

    '_lang' => "Brazilian Portuguese",
    '_native' => "Português Brasileiro",
    ...
    "You don't have permissions to upload files." => "Você não possui permissões para fazer upload de arquivos.",
    "You don't have permissions to browse server." => "Você não possui permissões para procurar arquivos no servidor.",
    "Cannot move uploaded file to target folder." => "Não é possível mover o arquivo enviado para a pasta de destino.",
    "Unknown error." => "Erro desconhecido.",
    "The uploaded file exceeds {size} bytes." => "O arquivo enviado é maior do que {size} bytes.",
    "The uploaded file was only partially uploaded." => "O arquivo foi apenas enviado parcialmente.",
    ...
    "Unknown image format/encoding." => "Formato de imagem codificado ou desconhecido.",
    ...
    "Unallowable characters in folder name." => "Caracteres no nome da pasta não são autorizados.",
    ...
    "Unallowable characters in file name." => "Caracteres no nome do arquivo não são utorizados.",
    ...
    "Are you sure you want to delete this folder and all its content?" => "Tem a certeza de que deseja excluir esta pasta e todo o seu conteúdo?",
    ...
    "Failed to delete {count} files/folders." => "Não foi possível excluir {count} arquivos/pastas.",
    ...
    "New file name:" => "Nome do novo arquivo:",
    ...
    "Failed to upload {filename}!" => "Falha ao enviar arquivo {filename}!",
    "Warning" => "Atenção",
    "Close" => "Fechar",
    "Previous" => "Anterior",
    "Next" => "Próximo",
